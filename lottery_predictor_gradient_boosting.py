...
class LotteryPredictorGradientBoosting:
    ...
    def train(self):
        ...
        # Entrenar modelos Gradient Boosting para números regulares
        for i in range(5):
        ...
        # Entrenar modelo Gradient Boosting para el complementario
        self.complementary_model = GradientBoostingRegressor(
            n_estimators=100,
            learning_rate=0.1,
            max_depth=3,
            random_state=42
