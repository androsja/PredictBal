...
class LotteryPredictorBagging:
    ...
    def train(self):
        ...
        # Entrenar modelos Bagging para números regulares
        for i in range(5):
        ...
        # Entrenar modelo Bagging para el complementario
        self.complementary_model = BaggingRegressor(
            estimator=DecisionTreeRegressor(max_depth=4),  # Menor profundidad para el complementario
            n_estimators=self.n_estimators,
            random_state=42
        )
