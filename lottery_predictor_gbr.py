...
class LotteryPredictorGBR:
    ...
    def train(self):
        ...
        # Entrenar modelos GBR para números regulares
        for i in range(5):
        ...
        # Entrenar modelo GBR para el complementario
        self.complementary_model = GradientBoostingRegressor(n_estimators=100, random_state=42)
