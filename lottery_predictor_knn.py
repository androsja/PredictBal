...
class LotteryPredictorKNN:
    ...
    def train(self):
        ...
        # Entrenar modelos KNN para números regulares
        for i in range(5):
        ...
        # Entrenar modelo KNN para el complementario
        self.complementary_model = KNeighborsRegressor(n_neighbors=self.n_neighbors)
